...
let numOfUnfundedGames = GAMES_JSON.reduce((count, game) => {
    return count + (game.pledged < game.goal ? 1 : 0);
}, 0).toLocaleString('en-US');

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = 
    `A total of $${totalRaised} has been raised for ${totalGames} games. Currently, ${numOfUnfundedGames} games remains unfunded. We need your help to fund these amazing games!`;
...
// click header to jump to our games
const headerText = document.querySelector('#header1');
